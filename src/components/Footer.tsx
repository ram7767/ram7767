      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <ul className="space-y-2">
              {navLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-[#8892b0] hover:text-[#8b5cf6] transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-[#8892b0]">
              <li>{data.location}</li>
              <li>
                <a href={`mailto:${data.email}`} className="hover:text-[#8b5cf6] transition-colors">
                  {data.email}
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-[#8b5cf6]/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[#8892b0] text-sm flex items-center gap-1">
            ...
            and lots of
            <span className="text-[#8b5cf6]">code</span>
          </p>
