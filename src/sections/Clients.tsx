  ...
  return (
    <section id="clients" ref={ref} className="relative py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-transparent bg-clip-text bg-gradient-to-r from-system-blue to-system-orange font-medium mb-2">Trusted By</p>
        ...
        {/* Trust Badges */}
        <div
          className={`mt-16 flex flex-wrap justify-center gap-8 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
        >
          {[
            ...
            <div key={badge.label} className="text-center px-6 py-4">
              <p className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-system-blue to-system-orange mb-1">{badge.value}</p>
