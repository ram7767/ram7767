  ...
  return (
    <section id="services" ref={ref} className="relative py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-transparent bg-clip-text bg-gradient-to-r from-system-blue to-system-orange font-medium mb-2">What I Do</p>
              ...
              >
                <div className="relative h-full p-8 bg-[#112240] border border-[#8b5cf6]/20 rounded-2xl overflow-hidden transition-all hover:border-[#8b5cf6]/50 hover:-translate-y-2 hover:shadow-xl hover:shadow-[#8b5cf6]/10">
                  ...
                  <div className="relative mb-6">
                    <div className="w-16 h-16 bg-gradient-to-br from-system-blue to-system-orange rounded-xl flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-3 transition-all">
                  ...
                  {/* Content */}
                  <h3 className="relative text-xl font-bold text-white mb-4 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-system-blue group-hover:to-system-orange transition-colors">
                    {service.title}
                  </h3>
                  ...
                  <a
                    href="#contact"
                    className="relative inline-flex items-center gap-2 text-transparent bg-clip-text bg-gradient-to-r from-system-blue to-system-orange font-medium group/link"
                  >
        ...
        {/* CTA */}
        <div
          className={`mt-16 text-center transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
        >
          <p className="text-[#8892b0] mb-4">Have a project in mind?</p>
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-8 py-3 bg-system-blue text-white rounded-lg font-medium hover:bg-system-blue-light transition-all hover:scale-105 hover:shadow-lg hover:shadow-system-blue/30"
          >
